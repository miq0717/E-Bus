...
ALTER TABLE SEAT
ADD BusID int NOT NULL
ALTER TABLE SEAT
ADD FOREIGN KEY (BusID)
REFERENCES BUSINFO(BusID)
ALTER TABLE SEAT
...
SELECT * FROM BUSINFO, SCHEDULE, ROUTENAME, SEAT  where BUSINFO.BusID = SCHEDULE.BusID and BUSINFO.RouteID = ROUTENAME.RouteID and SEAT.BusID=BUSINFO.BusID (SELECT * FROM ROUTENAME WHERE ROUTENAME.Destination='Dhaka' and ROUTENAME.SourceName='Sylhet'

SELECT * FROM ROUTENAME WHERE ROUTENAME.Destination='Sylhet' and ROUTENAME.SourceName='Dhaka'

SELECT COUNT(BusID) from SEAT where SEAT.BusID='1'

SELECT * from BUSINFO, SCHEDULE, ROUTENAME, SEAT  where BUSINFO.BusID = SCHEDULE.BusID and BUSINFO.RouteID = ROUTENAME.RouteID and SEAT.BusID=BUSINFO.BusID and ROUTENAME.Destination='Chittagong' and ROUTENAME.SourceName='Dhaka'